    ...
    <div class="container mx-auto mt-10 mb-10">
        <div class="bg-white p-5 rounded-xl shadow-sm ">
            ...
            <div>
                ...
                <form action="" method="GET" class="flex items-center pb-4 space-x-4 ">
                    {{-- menu serch data --}}
                    ...
                    <a href="" class="bg-green-500 hover:bg-green-600  text-white font-semibold p-3 w-60 rounded-lg inline-flex items-center">
